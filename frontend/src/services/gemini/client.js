...
const getApiKey = () => {
  return import.meta.env.VITE_API_GEMINI_KEY_1 || import.meta.env.VITE_GEMINI_API_KEY || '';
};
...
export async function generateContent(prompt, options = {}) {
  ...
  if (!apiKey) {
    throw new Error(
      "Gemini API key is missing. Please ensure VITE_API_GEMINI_KEY_1 or VITE_GEMINI_API_KEY is registered in your frontend/.env file."
    );
  }
